...
<head>
    ...
    <link rel="icon" type="logo" href="<?= get_template_directory_uri(); ?>/images/title-logo.png">
    <link rel="stylesheet" href="<?= get_template_directory_uri(); ?>/design.css">
...
<div class="navbar-container">
    <nav class="navbar">
        <img src="<?= get_template_directory_uri(); ?>/images/AD_Search logo.png" alt="AD Search Logo" class="logo-img">
        <ul class="nav-menu">
            <li class="nav-link">
...
<main>
    <section class="home">
        <div class="home-img">
            <img src="<?= get_template_directory_uri(); ?>/images/search_engines.png" alt="Search Engine Icons">
        </div>
