...
<main class="main">
    ...
    <div class="page-title dark-background">
        <div class="container position-relative">
            <h1>Статьи</h1>
            <p>Погрузитесь в инновации и передовые идеи с нашими статьями.</p>
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    <article>
                        <div class="post-img">
                            <img src="assets/img/articles/blog-1.jpg" alt="" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4">
                    <article>
                        <div class="post-img">
                            <img src="assets/img/articles/blog-2.jpg" alt="" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4">
                    <article>
                        <div class="post-img">
                            <img src="assets/img/articles/blog-3.jpg" alt="" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4">
                    <article>
                        <div class="post-img">
                            <img src="assets/img/articles/blog-4.jpg" alt="" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4">
                    <article>
                        <div class="post-img">
                            <img src="assets/img/articles/blog-5.jpg" alt="" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4">
                    <article>
                        <div class="post-img">
                            <img src="assets/img/articles/blog-6.jpg" alt="" class="img-fluid">
                        </div>
